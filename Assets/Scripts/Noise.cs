...
{
    public static float Get2DPerlinNoise(Vector2 position, float offset, float scale)
    {
    ...
    public static bool Get3DPerlinNoise(Vector3 position, float offset, float scale, float threshold)
    {
